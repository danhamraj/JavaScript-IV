...
/*
  ...
  Each constructor function has unique properties and methods that are defined in their block 
  comments below:
*/
...
class CharacterStats extends GameObject {
    constructor(CharacterStatsAttributes) {
        super(CharacterStatsAttributes); // super replaces.call
...
class Humanoid extends CharacterStats {
    ...
    //Humanoid = Object.create(CharacterStats)
